...
console.log(`Output box occupies rows: ${outputBoxStartY} to ${outputBoxStartY + outputBoxHeight_collapsed - 1}`)
console.log(`Textarea occupies rows: ${textareaTopY_collapsed} to ${textareaBottomY}`)
console.log(`Gap between: ${(outputBoxStartY + outputBoxHeight_collapsed - 1) + 1} to ${textareaTopY_collapsed - 1}`)
...
console.log(`Output box occupies rows: ${outputBoxStartY} to ${outputBoxStartY + outputBoxHeight_expanded - 1}`)
console.log(`Textarea occupies rows: ${textareaTopY_expanded} to ${textareaBottomY}`)

const gapStart = outputBoxStartY + outputBoxHeight_expanded
const gapEnd = textareaTopY_expanded - 1
if (gapStart <= gapEnd) {
  console.log(`❌ GAP DETECTED: rows ${gapStart} to ${gapEnd} (${gapEnd - gapStart + 1} rows)`)
} else {
  console.log(`✅ No gap`)
}
...
// Check boundary.
console.log(`\nBoundary check:`)
console.log(`  Last output box row: ${outputBoxStartY + outputBoxHeight_expanded - 1}`)
console.log(`  First textarea row: ${textareaTopY_expanded}`)
console.log(`  Should be adjacent: ${(outputBoxStartY + outputBoxHeight_expanded - 1) + 1 === textareaTopY_expanded ? '✅' : '❌'}`)
