...
import { getSocketbinBinaryPath, getSocketbinPackageDir } from "package-builder/scripts/paths.mts";
...
const { arch, libc, method: buildMethod, platform, version: providedVersion } = values;
