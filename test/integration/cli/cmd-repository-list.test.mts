 ...
 *
 * Related Files: - src/command/repository/cmd-repository-list.mts - Command
 * definition - src/command/repository/handle-repository-list.mts - Listing
 * logic - src/command/repository/output-repository-list.mts - Formatting.
 */
