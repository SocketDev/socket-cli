 ...
 *
 * Related Files: - src/command/ask/cmd-ask.mts - ask command implementation -
 * src/command/ask/handle-ask.mts - NLP query parsing -
 * src/command/ask/output-ask.mts - Output formatting.
 */
