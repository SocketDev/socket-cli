 ...
 *
 * Related Files: - src/command/optimize/handle-optimize.mts - Main command
    ...
    async cmd => {
      ...
      expect(stderr).toMatchInlineSnapshot(`
        "[DryRun]: Optimize dependencies with @socketregistry overrides (pnpm vX.Y.Z)
          ...
          Actions that would be performed:
            - [fetch] Detected pnpm vX.Y.Z \\u2192 [PROJECT]/test/fixtures/commands/optimize/pnpm
            - [fetch] Analyze dependencies against @socketregistry overrides \\u2192 package.json and lockfile
            - [modify] Add or update overrides section in package.json \\u2192 [PROJECT]/test/fixtures/commands/optimize/pnpm/package.json
