 ...
 * support.
 *
 * Related Files: - src/command/manifest/cmd-manifest-gradle.mts - Command
 * definition - src/command/manifest/handle-manifest-gradle.mts - Gradle
 * manifest logic.
 */
  ...
  cmdit(
    ...
    async cmd => {
      ...
      expect(`\n   ${stderr}`).toMatchInlineSnapshot(`
        ...
        [DryRun]: Would execute generate .socket.facts.json from Gradle project
