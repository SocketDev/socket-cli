/**
 * Integration tests for `socket scan list` command.
 *
 ...
 * markdown)
 *
 * Related Files: - src/command/scan/cmd-scan-list.mts - Command definition -
 * src/command/scan/handle-scan-list.mts - Listing logic -
 * src/command/scan/output-scan-list.mts - Formatting.
 */
