...
import { applyOptimization } from '../../../../src/core/optimize/apply-optimization.mts'
...
vi.mock(import('../../../../src/core/optimize/add-overrides.mts'), () => ({
  addOverrides: mockAddOverrides,
}))

vi.mock(
  import('../../../../src/core/optimize/update-dependencies.mts'),
  () => ({
