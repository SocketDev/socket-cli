...
import { runFirewallCommand } from '../../../../src/core/firewall/run.mts'
import type { FirewallPolicyOptions } from '../../../../src/core/firewall/policy/index.mts'
import type { FirewallChildResult } from '../../../../src/core/firewall/child.mts'
...
vi.mock(import('../../../../src/core/firewall/executable.mts'), () => ({
  resolveFirewallExecutable: mocks.resolve,
}))
vi.mock(import('../../../../src/core/firewall/certificates.mts'), () => ({
  ensureFirewallCertificateAuthority: mocks.ensureCa,
  loadFirewallCertificateAuthority: mocks.loadCa,
}))
vi.mock(import('../../../../src/core/firewall/child.mts'), () => ({
  spawnFirewallChild: mocks.spawn,
}))
vi.mock(
  import('../../../../src/core/firewall/config.mts'),
...
vi.mock(
  import('../../../../src/core/firewall/environment.mts'),
  async importOriginal => ({
    ...(await importOriginal<object>()),
...
vi.mock(import('../../../../src/core/firewall/policy/index.mts'), () => ({
  createFirewallPolicy: mocks.policy,
}))
vi.mock(import('../../../../src/core/firewall/proxy.mts'), () => ({
  startFirewallProxy: mocks.proxy,
}))
vi.mock(import('../../../../src/core/firewall/rebind.mts'), () => ({
