// "test" is a fixture username in mocked cwd / path test inputs; not a real
// personal path.
...
import { cmdJson } from '../../../../src/command/json/cmd-json.mts'

// Mock dependencies.
const mockHandleCmdJson = vi.hoisted(() => vi.fn())

vi.mock(import('../../../../src/command/json/handle-cmd-json.mts'), () => ({
