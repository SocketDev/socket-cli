...
import { cmdConfigAuto } from '../../../../src/command/config/cmd-config-auto.mts'
import { cmdConfigGet } from '../../../../src/command/config/cmd-config-get.mts'
import { cmdConfigList } from '../../../../src/command/config/cmd-config-list.mts'
import { cmdConfigSet } from '../../../../src/command/config/cmd-config-set.mts'
import { cmdConfigUnset } from '../../../../src/command/config/cmd-config-unset.mts'
import { cmdConfig } from '../../../../src/command/config/cmd-config.mts'
