 ...
 * pattern flow.
 *
 * Related Files: - src/command/config/handle-config-get.mts - Implementation -
 * src/util/config.mts - Config file utilities -
 * src/command/config/output-config-get.mts - Output formatter.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { handleConfigGet } from '../../../../src/command/config/handle-config-get.mts'
import {
  createErrorResult,
  createSuccessResult,
...
vi.mock(import('../../../../src/command/config/output-config-get.mts'), () => ({
...
describe('handleConfigGet', () => {
  ...
  it('gets config value successfully', async () => {
    ...
    const { outputConfigGet } =
      await import('../../../../src/command/config/output-config-get.mts')
