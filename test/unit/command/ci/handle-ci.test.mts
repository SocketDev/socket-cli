 ...
 *
 * Related Files: - src/command/ci/handle-ci.mts - Implementation -
 * src/command/ci/fetch-default-org-slug.mts - Org detection -
 * src/command/scan/handle-create-new-scan.mts - Scan creation.
 */

import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'

import { handleCi } from '../../../../src/command/ci/handle-ci.mts'
