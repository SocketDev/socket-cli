 ...
 *
 * Related Files: - src/command/fix/coana-fix.mts (implementation) -
 * test/unit/command/fix/handle-fix-limit.test.mts (sibling)
 */
...
describe('coanaFix (coverage)', () => {
  ...
  describe('local mode info messages', () => {
    ...
    it('returns the spawnCoana error in local mode', async () => {
  ...
  describe('CI mode discovery', () => {
    ...
    it('handles spawnCoana throwing during discovery', async () => {
