 ...
 * identifiers.
 *
 * Related Files: - src/command/fix/handle-fix.mts - Main fix command handler -
 * src/util/cve-to-ghsa.mts - CVE ID conversion utility -
 * src/util/purl/to-ghsa.mts - PURL to GHSA conversion -
 * src/command/fix/coana-fix.mts - Coana API integration for applying fixes.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { convertIdsToGhsas } from '../../../../src/command/fix/handle-fix.mts'
...
vi.mock(import('../../../../src/command/fix/coana-fix.mts'), () => ({
  coanaFix: mockCoanaFix,
}))
vi.mock(import('../../../../src/command/fix/output-fix-result.mts'), () => ({
...
describe('handleFix', () => {
  ...
  it('runs coanaFix and pipes the result through outputFixResult', async () => {
    const { handleFix } =
      await import('../../../../src/command/fix/handle-fix.mts')
