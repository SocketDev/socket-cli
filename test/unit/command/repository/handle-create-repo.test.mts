 ...
 * orchestration logic.
 *
 * Related Files: - src/command/repository/handle-create-repo.mts
 * (implementation) - src/command/repository/fetch-create-repo.mts (API
 * fetcher) - src/command/repository/output-create-repo.mts (formatter)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { handleCreateRepo } from '../../../../src/command/repository/handle-create-repo.mts'
...
vi.mock(
  import('../../../../src/command/repository/fetch-create-repo.mts'),
  () => ({
    fetchCreateRepo: mockFetchCreateRepo,
  }),
)
vi.mock(
  import('../../../../src/command/repository/output-create-repo.mts'),
  () => ({
