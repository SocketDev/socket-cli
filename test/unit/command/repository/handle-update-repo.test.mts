 ...
 * orchestration logic.
 *
 * Related Files: - src/command/repository/handle-update-repo.mts
 * (implementation) - src/command/repository/fetch-update-repo.mts (API
 * fetcher) - src/command/repository/output-update-repo.mts (formatter)
 */

import { describe, expect, it, vi } from 'vitest'

import { handleUpdateRepo } from '../../../../src/command/repository/handle-update-repo.mts'
...
vi.mock(
  import('../../../../src/command/repository/fetch-update-repo.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/repository/output-update-repo.mts'),
  () => ({
