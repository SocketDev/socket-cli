 ...
 * orchestration logic.
 *
 * Related Files: - src/command/repository/handle-view-repo.mts
 * (implementation) - src/command/repository/fetch-view-repo.mts (API fetcher)
 *
...
import { handleViewRepo } from '../../../../src/command/repository/handle-view-repo.mts'
...
vi.mock(
  import('../../../../src/command/repository/fetch-view-repo.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/repository/output-view-repo.mts'),
  () => ({
