 ...
 *
 * Related Files: - src/command/repository/handle-delete-repo.mts
 * (implementation) - src/command/repository/fetch-delete-repo.mts (API
 * fetcher) - src/command/repository/output-delete-repo.mts (formatter)
 */
...
vi.mock(
  import('../../../../src/command/repository/fetch-delete-repo.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/repository/output-delete-repo.mts'),
  () => ({
...
const { handleDeleteRepo } =
  ...
  await import('../../../../src/command/repository/handle-delete-repo.mts')
