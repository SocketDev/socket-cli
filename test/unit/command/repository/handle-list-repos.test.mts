 ...
 *
 * Related Files: - src/command/repository/handle-list-repos.mts
 * (implementation) - src/command/repository/fetch-list-repos.mts (API fetcher)
 *
...
import { handleListRepos } from '../../../../src/command/repository/handle-list-repos.mts'
...
vi.mock(
  import('../../../../src/command/repository/fetch-list-repos.mts'),
  () => ({
    fetchListRepos: mockFetchListRepos,
  }),
)
vi.mock(
  import('../../../../src/command/repository/output-list-repos.mts'),
  () => ({
