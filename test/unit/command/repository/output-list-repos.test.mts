 ...
 *
 * Related Files: - src/command/repository/output-list-repos.mts
 * (implementation) - src/command/repository/handle-list-repos.mts (handler)
 */
...
import type { CResult } from '../../../../src/command/repository/types.mts'
...
describe('outputListRepos', () => {
  ...
  it('outputs JSON format for successful result with pagination', async () => {
    ...
    const { outputListRepos } =
      await import('../../../../src/command/repository/output-list-repos.mts')
