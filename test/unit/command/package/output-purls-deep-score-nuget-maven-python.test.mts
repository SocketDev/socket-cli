...
import mavenDeep from '../../../../src/command/package/fixtures/maven_deep.json' with { type: 'json' }
import nugetDeep from '../../../../src/command/package/fixtures/nuget_deep.json' with { type: 'json' }
import pythonDeep from '../../../../src/command/package/fixtures/python_deep.json' with { type: 'json' }
