...
import goShallow from '../../../../src/command/package/fixtures/go_shallow.json' with { type: 'json' }
import mavenShallow from '../../../../src/command/package/fixtures/maven_shallow.json' with { type: 'json' }
import npmShallow from '../../../../src/command/package/fixtures/npm_shallow.json' with { type: 'json' }
import nugetShallow from '../../../../src/command/package/fixtures/nuget_shallow.json' with { type: 'json' }
import rubyShallow from '../../../../src/command/package/fixtures/ruby_shallow.json' with { type: 'json' }
import {
  formatReportCard,
  generateMarkdownReport,
  generateTextReport,
  preProcess,
} from '../../../../src/command/package/output-purls-shallow-score.mts'

import type { DedupedArtifact } from '../../../../src/command/package/output-purls-shallow-score.mts'
