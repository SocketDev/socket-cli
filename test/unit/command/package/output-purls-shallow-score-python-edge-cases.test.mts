...
import pythonDupes from '../../../../src/command/package/fixtures/python_dupes.json' with { type: 'json' }
import pythonShallow from '../../../../src/command/package/fixtures/python_shallow.json' with { type: 'json' }
import {
