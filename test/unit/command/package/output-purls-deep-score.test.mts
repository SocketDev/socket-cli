 ...
 * across multiple ecosystems. Deep scores include package + transitive
 * dependencies. Uses snapshot testing to ensure consistent report formatting
 * across npm, Go, Ruby, NuGet, Maven, and Python ecosystems.
 *
 * Test Coverage:
 *
 ...
 * snapshot testing to validate comprehensive markdown report structure across
...
import goDeep from '../../../../src/command/package/fixtures/go_deep.json' with { type: 'json' }
import npmDeep from '../../../../src/command/package/fixtures/npm_deep.json' with { type: 'json' }
import rubyDeep from '../../../../src/command/package/fixtures/ruby_deep.json' with { type: 'json' }
import { createMarkdownReport } from '../../../../src/command/package/output-purls-deep-score.mts'
