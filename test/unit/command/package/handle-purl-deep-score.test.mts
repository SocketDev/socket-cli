 ...
 * layers.
 *
 * Related Files: - src/command/package/handle-purl-deep-score.mts
 * (implementation) - src/command/package/fetch-purl-deep-score.mts (API
 * fetcher) - src/command/package/output-purls-deep-score.mts (formatter)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { handlePurlDeepScore } from '../../../../src/command/package/handle-purl-deep-score.mts'
...
vi.mock(
  import('../../../../src/command/package/fetch-purl-deep-score.mts'),
  () => ({
    fetchPurlDeepScore: mockFetchPurlDeepScore,
  }),
)
vi.mock(
  import('../../../../src/command/package/output-purls-deep-score.mts'),
  () => ({
