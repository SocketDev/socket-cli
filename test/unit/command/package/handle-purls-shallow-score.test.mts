 ...
 *
 * Related Files: - src/command/package/handle-purls-shallow-score.mts
 * (implementation) - src/command/package/fetch-purls-shallow-score.mts (API
 * fetcher) - src/command/package/output-purls-shallow-score.mts (formatter)
 */
...
import { fetchPurlsShallowScore } from '../../../../src/command/package/fetch-purls-shallow-score.mts'
import { handlePurlsShallowScore } from '../../../../src/command/package/handle-purls-shallow-score.mts'
import { outputPurlsShallowScore } from '../../../../src/command/package/output-purls-shallow-score.mts'
...
vi.mock(
  import('../../../../src/command/package/fetch-purls-shallow-score.mts'),
  () => ({
    fetchPurlsShallowScore: mockFetchPurlsShallowScore,
  }),
)
vi.mock(
  import('../../../../src/command/package/output-purls-shallow-score.mts'),
  () => ({
