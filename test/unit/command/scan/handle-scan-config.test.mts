 ...
 * pipeline.
 *
 * Related Files: - src/command/handleScanConfig.mts (implementation)
 */
...
import { handleScanConfig } from '../../../../src/command/scan/handle-scan-config.mts'
...
vi.mock(
  import('../../../../src/command/scan/output-scan-config-result.mts'),
  () => ({
    outputScanConfigResult: mockOutputScanConfigResult,
  }),
)

vi.mock(import('../../../../src/command/scan/setup-scan-config.mts'), () => ({
