 ...
 * pipeline.
 *
 * Related Files: - src/command/handleListScans.mts (implementation)
 */
...
import { handleListScans } from '../../../../src/command/scan/handle-list-scans.mts'

// Mock the dependencies.
const mockFetchOrgFullScanList = vi.hoisted(() => vi.fn())
const mockOutputListScans = vi.hoisted(() => vi.fn())

vi.mock(import('../../../../src/command/scan/fetch-list-scans.mts'), () => ({
  fetchOrgFullScanList: mockFetchOrgFullScanList,
}))

vi.mock(import('../../../../src/command/scan/output-list-scans.mts'), () => ({
...
describe('handleListScans', () => {
  it('fetches and outputs scan list successfully', async () => {
    ...
    await import('../../../../src/command/scan/output-list-scans.mts')
