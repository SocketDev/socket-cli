 ...
 * pipeline.
 *
 * Related Files: - src/command/handleScanReport.mts (implementation)
 */
...
vi.mock(import('../../../../src/command/scan/fetch-report-data.mts'), () => ({
  fetchScanData: mockFetchScanData,
}))

vi.mock(import('../../../../src/command/scan/output-scan-report.mts'), () => ({
