 ...
 *
 * Related Files: - src/command/scan/setup-scan-config.mts (implementation)
 */
...
import {
  ...
  notCanceled,
  setupScanConfig,
} from '../../../../src/command/scan/setup-scan-config.mts'
...
vi.mock(
  import('@socketsecurity/lib-stable/env/github'),
