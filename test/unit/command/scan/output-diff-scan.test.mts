 ...
 *
 * Related Files: - src/command/scan/output-diff-scan.mts (implementation)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'
import type { CResult } from '../../../../src/types.mts'
import { outputDiffScan } from '../../../../src/command/scan/output-diff-scan.mts'
...
function createMockDiffData(overrides = {}) {
  return {
    diff_scan: {
      ...
      description: 'Example scan comparison',
      external_href: 'https://example.com/comparison',
      merge: false,
      html_url: 'https://socket.dev/diff/123',
      api_url: 'https://api.socket.dev/v0/diff/123',
      incomplete: false,
      artifacts: {
        added: [],
        removed: [],
