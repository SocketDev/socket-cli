 ...
 * pipeline.
 *
 * Related Files: - src/command/handleDiffScan.mts (implementation)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { handleDiffScan } from '../../../../src/command/scan/handle-diff-scan.mts'
import {
  createErrorResult,
  createSuccessResult,
...
vi.mock(import('../../../../src/command/scan/fetch-diff-scan.mts'), () => ({
  fetchDiffScan: mockFetchDiffScan,
}))

vi.mock(import('../../../../src/command/scan/output-diff-scan.mts'), () => ({
