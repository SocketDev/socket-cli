 ...
 * call error scenarios - Custom SDK options (API tokens, base URLs) - Detailed
 * report retrieval - Alert data - Score information - Null prototype usage for
 * security.
 *
 ...
 *
 * Related Files: - src/command/ReportData.mts (implementation)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { createErrorResult } from '../../../helpers/index.mts'
...
describe('fetchScanData', () => {
  ...
  it('handles SDK setup failure', async () => {
    ...
    const { fetchScanData } =
      await import('../../../../src/command/scan/fetch-report-data.mts')
