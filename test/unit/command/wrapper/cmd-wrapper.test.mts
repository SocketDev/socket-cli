...
import { cmdWrapper } from '../../../../src/command/wrapper/cmd-wrapper.mts'
...
vi.mock(
  import('../../../../src/command/wrapper/remove-socket-wrapper.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/wrapper/postinstall-wrapper.mts'),
  () => ({
