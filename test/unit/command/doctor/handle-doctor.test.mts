...
import { handleDoctor } from '../../../../src/command/doctor/handle-doctor.mts'
...
vi.mock(
  import('../../../../src/core/optimize/update-pnpm-workspace-yaml.mts'),
  () => ({
...
vi.mock(import('../../../../src/command/doctor/practice-checks.mts'), () => ({
