 ...
 *
 * Purpose: Tests the Socket SDK integration that fetches security policy
 * configuration for an organization. Validates policy retrieval including
 * severity blocking rules, auto-scan settings, and approval requirements.
 * Handles SDK setup, API errors, custom configuration, and various organization
 ...
 *
 * Related Files: - src/command/organization/fetch-security-policy.mts -
 * Security policy fetcher -
 * src/command/organization/handle-security-policy.mts - Command handler -
 * src/command/organization/output-security-policy.mts - Output formatter.
 */
