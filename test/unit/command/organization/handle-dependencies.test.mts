 ...
 * organization-wide dependency information. Validates parameter forwarding,
 * pagination handling, output format selection, and error propagation through
 ...
 * test environment setup helpers for consistent test isolation.
 *
 * Related Files: - src/command/organization/handle-dependencies.mts - Command
 * handler - src/command/organization/fetch-dependencies.mts - Dependencies
 * fetcher - src/command/organization/output-dependencies.mts - Output
 * formatter.
 */
...
import { handleDependencies } from '../../../../src/command/organization/handle-dependencies.mts'
import { outputDependencies } from '../../../../src/command/organization/output-dependencies.mts'
import {
  createSuccessResult,
...
vi.mock(
  import('../../../../src/command/organization/fetch-dependencies.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/organization/output-dependencies.mts'),
  () => ({
