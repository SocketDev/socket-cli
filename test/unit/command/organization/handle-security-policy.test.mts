 ...
 *
 * Related Files: - src/command/organization/handle-security-policy.mts -
 * Command handler - src/command/organization/fetch-security-policy.mts -
...
import { handleSecurityPolicy } from '../../../../src/command/organization/handle-security-policy.mts'
import { outputSecurityPolicy } from '../../../../src/command/organization/output-security-policy.mts'
import {
  createErrorResult,
  createSuccessResult,
...
vi.mock(
  import('../../../../src/command/organization/fetch-security-policy.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/organization/output-security-policy.mts'),
  () => ({
