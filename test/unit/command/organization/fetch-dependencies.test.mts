 ...
 * pattern usage.
 *
 * Related Files: - src/command/organization/fetch-dependencies.mts -
 * Dependencies fetcher - src/command/organization/handle-dependencies.mts -
 * Command handler - src/command/organization/output-dependencies.mts - Output
 * formatter.
 */
