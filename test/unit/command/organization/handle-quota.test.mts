 ...
 *
 * - Multiple output kind support, json, markdown, table - Error propagation from
 *   fetchQuota preventing output.
 *
 * Testing Approach: Mocks fetchQuota and outputQuota modules to test
 * orchestration logic without actual API calls or terminal output. Uses test
 * environment setup helpers for consistent isolation.
 *
 * Related Files: - src/command/organization/handle-quota.mts - Command
 * handler.
 *
 * - Src/commands/organization/fetch-quota.mts - Quota fetcher -
 *   src/command/organization/output-quota.mts - Output formatter.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { fetchQuota } from '../../../../src/command/organization/fetch-quota.mts'
import { handleQuota } from '../../../../src/command/organization/handle-quota.mts'
import { outputQuota } from '../../../../src/command/organization/output-quota.mts'
...
vi.mock(import('../../../../src/command/organization/fetch-quota.mts'), () => ({
  fetchQuota: mockFetchQuota,
}))

vi.mock(
  import('../../../../src/command/organization/output-quota.mts'),
  () => ({
