 ...
 *
 * Related Files: - src/command/organization/handle-organization-list.mts -
 * Command handler - src/command/organization/fetch-organization-list.mts -
 * Organization list fetcher -
 * src/command/organization/output-organization-list.mts - Output formatter
 * not in test files.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { fetchOrganization } from '../../../../src/command/organization/fetch-organization-list.mts'
import { handleOrganizationList } from '../../../../src/command/organization/handle-organization-list.mts'
import { outputOrganizationList } from '../../../../src/command/organization/output-organization-list.mts'
...
vi.mock(
  import('../../../../src/command/organization/fetch-organization-list.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/organization/output-organization-list.mts'),
  () => ({
...
describe('handleOrganizationList', () => {
  ...
  it('uses default text output format', async () => {
    ...
    expect(outputOrganizationList).toHaveBeenCalledWith(
      expect.any(Object),
      'text',
    )
  })
