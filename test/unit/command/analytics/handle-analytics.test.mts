 ...
 *
 * Tests the main handler logic that orchestrates analytics data fetching and
 * output. Validates routing between organization and repository analytics based
 * on scope.
 *
 * Test Coverage: - Organization analytics fetch when scope is 'org' -
 ...
 * createSuccessResult/createErrorResult helpers for CResult pattern - Verify
 * correct function selection based on scope parameter - Test validation logic
 * before API calls.
 *
 * Related Files: - src/command/analytics/handle-analytics.mts -
 * Implementation.
 *
 * - Src/commands/analytics/fetch-org-analytics.mts - Org data fetcher -
 *   src/command/analytics/fetch-repo-analytics.mts - Repo data fetcher -
 *   src/command/analytics/output-analytics.mts - Output formatter.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { fetchOrgAnalyticsData } from '../../../../src/command/analytics/fetch-org-analytics.mts'
import { fetchRepoAnalyticsData } from '../../../../src/command/analytics/fetch-repo-analytics.mts'
import { handleAnalytics } from '../../../../src/command/analytics/handle-analytics.mts'
import { outputAnalytics } from '../../../../src/command/analytics/output-analytics.mts'
import {
  createErrorResult,
  createSuccessResult,
...
vi.mock(
  import('../../../../src/command/analytics/fetch-org-analytics.mts'),
  () => ({
    fetchOrgAnalyticsData: mockFetchOrgAnalyticsData,
  }),
)
vi.mock(
  import('../../../../src/command/analytics/fetch-repo-analytics.mts'),
  () => ({
    fetchRepoAnalyticsData: mockFetchRepoAnalyticsData,
  }),
)
vi.mock(
  import('../../../../src/command/analytics/output-analytics.mts'),
  () => ({
