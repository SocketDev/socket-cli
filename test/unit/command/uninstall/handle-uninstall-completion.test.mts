 ...
 * handling.
 *
 * Related Files: - src/command/uninstall/handle-uninstall-completion.mts -
 * Command handler - src/command/uninstall/teardown-tab-completion.mts -
 * Completion removal logic -
 * src/command/uninstall/output-uninstall-completion.mts - Output formatting.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { handleUninstallCompletion } from '../../../../src/command/uninstall/handle-uninstall-completion.mts'

// Mock the dependencies.
vi.mock(
  import('../../../../src/command/uninstall/output-uninstall-completion.mts'),
  () => ({
    outputUninstallCompletion: vi.fn(),
  }),
)
vi.mock(
  import('../../../../src/command/uninstall/teardown-tab-completion.mts'),
  () => ({
...
describe('handleUninstallCompletion', () => {
  ...
  it('uninstalls completion successfully', async () => {
    const { teardownTabCompletion } =
      await import('../../../../src/command/uninstall/teardown-tab-completion.mts')
    const { outputUninstallCompletion } =
      await import('../../../../src/command/uninstall/output-uninstall-completion.mts')
