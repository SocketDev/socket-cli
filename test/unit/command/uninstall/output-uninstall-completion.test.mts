 ...
 *
 * Related Files: - src/command/uninstall/output-uninstall-completion.mts
 * (implementation)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'
import { outputUninstallCompletion } from '../../../../src/command/uninstall/output-uninstall-completion.mts'
