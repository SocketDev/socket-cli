 ...
 * and `gradleOpts`/`sbtOpts` are untrusted input. These tests pin the rule: the
 * conventional wrapper still runs with no friction, a redirected bin or any
 * repo-supplied option is refused, and an explicit CLI flag is honored. The
 * conda path half lives in manifest-build-trust-conda.test.mts.
 *
 * Related Files:
 *
...
import {
  ...
  splitBuildToolOpts,
} from '../../../../src/command/manifest/manifest-build-trust.mts'
