 ...
 *
 * Related Files: - src/command/manifest/cmd-manifest-cdxgen.mts - Command
 * implementation - src/command/manifest/run-cdxgen.mts - cdxgen spawning
 * logic.
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

import { cmdManifestCdxgen } from '../../../../src/command/manifest/cmd-manifest-cdxgen.mts'
...
vi.mock(import('../../../../src/command/manifest/run-cdxgen.mts'), () => ({
