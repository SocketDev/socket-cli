 ...
 * subcommands.
 *
 * Related Files: - src/command/manifest/cmd-manifest.mts - Command
...
import { cmdManifest } from '../../../../src/command/manifest/cmd-manifest.mts'
...
vi.mock(
  import('../../../../src/command/manifest/cmd-manifest-auto.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/manifest/cmd-manifest-gradle.mts'),
  () => ({
    cmdManifestGradle: {
      description: 'Generate gradle manifest',
      hidden: false,
    },
  }),
)
...
vi.mock(
  import('../../../../src/command/manifest/cmd-manifest-kotlin.mts'),
  () => ({
    cmdManifestKotlin: {
      description: 'Generate kotlin manifest',
      hidden: false,
    },
  }),
)
...
vi.mock(
  import('../../../../src/command/manifest/cmd-manifest-scala.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/command/manifest/cmd-manifest-setup.mts'),
  () => ({
