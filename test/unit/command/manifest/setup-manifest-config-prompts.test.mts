/**
 * Unit tests for setup-manifest-config prompt helpers.
 *
 * Related Files: - src/command/manifest/setup-manifest-config.mts
 * (implementation)
 */
...
import {
  ...
  canceledByUser,
  notCanceled,
} from '../../../../src/command/manifest/setup-manifest-config.mts'
