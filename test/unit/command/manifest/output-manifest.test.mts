 ...
 *
 * Related Files: - src/command/manifest/output-manifest.mts (implementation)
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'
import { outputManifest } from '../../../../src/command/manifest/output-manifest.mts'
import type { ManifestResult } from '../../../../src/command/manifest/output-manifest.mts'
