...
import { validateOutputBase } from '../../../../../src/command/manifest/bazel/bazel-output-base-check.mts'
import { parseBazelModPipExtensionCandidates } from '../../../../../src/command/manifest/bazel/bazel-pypi-candidates.mts'
import { discoverPypiHubs } from '../../../../../src/command/manifest/bazel/bazel-pypi-discovery.mts'
import {
  runBazelModShowPipExtension,
  runBazelQuery,
} from '../../../../../src/command/manifest/bazel/bazel-query-runner.mts'
import { detectWorkspaceMode } from '../../../../../src/command/manifest/bazel/bazel-workspace-detect.mts'
import { extractBazelToPypi } from '../../../../../src/command/manifest/bazel/extract_bazel_to_pypi.mts'
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-workspace-detect.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-bin-detect.mts'),
  () => ({
    resolveBazelBinary: vi.fn(async () => '/usr/local/bin/bazel'),
  }),
)
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-pypi-candidates.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-pypi-discovery.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-query-runner.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-output-base-check.mts'),
  () => ({
    validateOutputBase: vi.fn(),
  }),
)
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-python-shim.mts'),
  () => ({
