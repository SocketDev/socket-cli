...
import { runMetadataCqueryForRepo } from '../../../../../src/command/manifest/bazel/bazel-cquery.mts'
import {
  buildMavenProbeFor,
...
import { findWorkspaceRoots } from '../../../../../src/command/manifest/bazel/bazel-workspace-walk.mts'
import { extractBazelToMaven } from '../../../../../src/command/manifest/bazel/extract_bazel_to_maven.mts'
import {
  mkArt,
  mkResult,
  PROBE_NOT_DEFINED,
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-java-shim.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-workspace-walk.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/bazel-cquery.mts'),
  () => ({
