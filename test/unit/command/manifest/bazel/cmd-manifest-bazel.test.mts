...
} from '../../../../../src/command/manifest/bazel/cmd-manifest-bazel.mts'
...
import type { EcosystemOutcome } from '../../../../../src/command/manifest/bazel/cmd-manifest-bazel.mts'
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/extract_bazel_to_maven.mts'),
  () => ({
...
vi.mock(
  import('../../../../../src/command/manifest/bazel/extract_bazel_to_pypi.mts'),
  () => ({
