 ...
 *
 * Related Files: - src/command/manifest/handle-manifest-conda.mts - Command
 * handler - src/command/manifest/convert-conda-to-requirements.mts -
 * Conversion logic - src/command/manifest/output-requirements.mts - Output
 * formatting.
 */

import { describe, expect, it, vi } from 'vitest'

import { handleManifestConda } from '../../../../src/command/manifest/handle-manifest-conda.mts'
import {
  createErrorResult,
  createSuccessResult,
...
vi.mock(
  import('../../../../src/command/manifest/convert-conda-to-requirements.mts'),
  () => ({
...
describe('handleManifestConda', () => {
  it('converts conda file and outputs requirements successfully', async () => {
    await import('../../../../src/command/manifest/convert-conda-to-requirements.mts')
    await import('../../../../src/command/manifest/output-requirements.mts')
