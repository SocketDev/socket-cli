// "testuser" is a fixture username in expected dry-run output strings; not a
// real personal path.
...
import { cmdInstallCompletion } from '../../../../src/command/install/cmd-install-completion.mts'
...
vi.mock(
  import('../../../../src/command/install/handle-install-completion.mts'),
  () => ({
