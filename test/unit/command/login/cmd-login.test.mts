...
import { CMD_NAME, cmdLogin } from '../../../../src/command/login/cmd-login.mts'
...
vi.mock(import('../../../../src/command/login/attempt-login.mts'), () => ({
...
vi.mock(
  import('../../../../src/command/login/attempt-device-login.mts'),
  () => ({
