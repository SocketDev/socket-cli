 ...
 */
export function ignoreUnsupportedFilesPlugin(): Plugin {
  return {
...
export function resolveSocketLibInternalsPlugin(): Plugin {
 ...
 */
export function stubProblematicPackagesPlugin(): Plugin {
