...
export async function queryApiSafeTextWithStatus(
  ...
  startApiQuerySpinner(spinner, description)
...
export function startApiQuerySpinner(
  spinner: ReturnType<typeof getDefaultSpinner>,
  description?: string | undefined,
): void {
  if (description) {
