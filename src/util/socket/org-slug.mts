...
import { suggestOrgSlug } from '../../command/scan/suggest-org-slug.mjs'
import { suggestToPersistOrgSlug } from '../../command/scan/suggest-to-persist-orgslug.mjs'
...
// exported call sites span a dozen command modules + a dedicated test suite,
// outside this fix's scope; an options-object migration needs every call site
// updated together.
