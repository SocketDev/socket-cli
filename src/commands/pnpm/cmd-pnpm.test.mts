  ...
  cmdit(
    ...
    async cmd => {
      ...
      expect(stdout).toMatchInlineSnapshot(`
        ...
        .
        \\u251c\\u2500\\u252c vitest 3.2.4
        \\u2502 \\u251c\\u2500\\u2500 \\u2715 unmet peer @types/node@24.6.2: found 20.19.20
        \\u2502 \\u2514\\u2500\\u252c vite 7.1.7
        \\u2502   \\u2514\\u2500\\u2500 \\u2715 unmet peer @types/node@24.6.2: found 20.19.20
        \\u2514\\u2500\\u252c knip 5.63.1
          \\u2514\\u2500\\u2500 \\u2715 unmet peer @types/node@24.6.2: found 20.19.20
        ...
        devDependencies:
        - @types/node 24.6.2
        + @types/node 20.19.20 (24.7.1 is available) already in devDependencies, was not moved to dependencies.
  ...
  cmdit(
    ...
    async cmd => {
      ...
      expect(stdout).toMatchInlineSnapshot(`
        ...
        devDependencies:
        - @types/node 20.19.20
        + @types/node 24.6.2 (24.7.1 is available)
