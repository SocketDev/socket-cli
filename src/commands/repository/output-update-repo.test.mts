...
describe('outputUpdateRepo', () => {
  ...
  it('outputs success message for successful update', async () => {
    ...
    expect(mockSuccess).toHaveBeenCalledWith('Repository `my-repository` updated successfully')
    expect(process.exitCode).toBeUndefined()
  })
  ...
  it('handles markdown output format', async () => {
    ...
    expect(mockSuccess).toHaveBeenCalledWith('Repository `markdown-repo` updated successfully')
  })
  ...
  it('handles empty repository name', async () => {
    ...
    expect(mockSuccess).toHaveBeenCalledWith('Repository `` updated successfully')
  })
