import { VLT } from '@socketsecurity/lib-stable/eco/npm/constants/package-managers'
import { debug, debugDir } from '@socketsecurity/lib-stable/debug/output'
import { getDefaultLogger } from '@socketsecurity/lib-stable/logger/default'

import { applyOptimization } from '../../core/optimize/apply-optimization.mts'
import { bundleStubOffer } from '../../core/optimize/bundle-stub-offer.mts'
import { hoistAdvisory } from '../../core/optimize/hoist-advisory.mts'
import { outputOptimizeResult } from './output-optimize-result.mts'
import { runPastoralistAudit } from '../../core/optimize/pastoralist-audit.mts'
import { CMD_NAME } from './shared.mts'
import { syncOriginMain } from '../../core/optimize/sync-origin-main.mts'
