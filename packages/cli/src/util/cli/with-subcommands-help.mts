...
import { FLAG_HELP_FULL, FLAG_JSON, FLAG_MARKDOWN } from "../../constants/cli.mts";
...
export function buildHelpLines(opts: BuildHelpLinesOptions): string[] {
  const { aliases, argv, buckets, flags, isRootCommand, name, subcommands } = opts;
...
export function describeOrFallback(cmd: CliSubcommand | undefined, fallback: string): string {
...
export function pushEnvironmentVariables(lines: string[], argv: readonly string[]): void {
