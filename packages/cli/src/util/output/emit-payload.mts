...
export function emitJsonPayload(value: unknown, options: EmitPayloadOptions): void {
...
export function emitPayload(payload: string, options: EmitPayloadOptions): void {
