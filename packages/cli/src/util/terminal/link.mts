 ...
 */
export function socketDashboardLink(dashPath: string, text?: string | undefined): string {
 ...
 */
export function socketDevLink(text?: string | undefined, urlPath?: string | undefined): string {
  return terminalLink(text ?? "Socket.dev", `${SOCKET_WEBSITE_URL}${urlPath || ""}`);
}

/**
 * Creates a terminal link to Socket.dev documentation.
 */
export function socketDocsLink(docPath: string, text?: string | undefined): string {
