...
import { CollatorStub } from './intl-stub/collator.mts'
import { DateTimeFormatStub } from './intl-stub/date-time-format.mts'
import { DisplayNamesStub } from './intl-stub/display-names.mts'
import { getCanonicalLocales, supportedValuesOf } from './intl-stub/helpers.mts'
import { ListFormatStub } from './intl-stub/list-format.mts'
import { LocaleStub } from './intl-stub/locale.mts'
import { NumberFormatStub } from './intl-stub/number-format.mts'
import { PluralRulesStub } from './intl-stub/plural-rules.mts'
import { RelativeTimeFormatStub } from './intl-stub/relative-time-format.mts'
import { SegmenterStub } from './intl-stub/segmenter.mts'
