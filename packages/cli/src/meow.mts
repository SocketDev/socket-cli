...
type ValueOfFlagType<F extends MeowFlag> = F["type"] extends "string"
  ...
  : F["type"] extends "number"
    ...
    : F["type"] extends "boolean"
      ? boolean
      : unknown;
type ValueOrArray<F extends MeowFlag, V> = F["isMultiple"] extends true ? V[] : V;
type ValueOrUndefined<F extends MeowFlag, V> = F["default"] extends undefined
  ...
  : F extends { default: infer D }
    ? D extends undefined
      ...
      : V
    : V | undefined;
type InferFlagValue<F extends MeowFlag> = ValueOrUndefined<F, ValueOrArray<F, ValueOfFlagType<F>>>;
