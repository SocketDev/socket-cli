...
export const SOCKET_CLI_SENTRY_NPM_BIN_NAME = "@socketsecurity/cli-with-sentry-npm";
export const SOCKET_CLI_SENTRY_NPX_BIN_NAME = "@socketsecurity/cli-with-sentry-npx";
export const SOCKET_CLI_SENTRY_PNPM_BIN_NAME = "@socketsecurity/cli-with-sentry-pnpm";
export const SOCKET_CLI_SENTRY_YARN_BIN_NAME = "@socketsecurity/cli-with-sentry-yarn";
