...
export const SOCKET_SETTINGS_API_TOKENS_URL = "https://socket.dev/settings/api-tokens";
...
// Documentation
export const V1_MIGRATION_GUIDE_URL = "https://docs.socket.dev/docs/v1-migration-guide";

// GitHub
export const SOCKET_CLI_ISSUES_URL = "https://github.com/SocketDev/socket-cli/issues";
