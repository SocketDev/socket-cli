...
export { WIN32 } from '@socketsecurity/lib-internal/constants/platform'
export type { Remap } from '@socketsecurity/lib-internal/objects'
export type { SpawnOptions } from '@socketsecurity/lib-internal/spawn'
