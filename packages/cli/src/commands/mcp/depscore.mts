  ...
  packages: Type.Array(
    Type.Object({
      ...
      ecosystem: Type.Optional(
        Type.String({
          default: "npm",
          description: "The package ecosystem (e.g., npm, pypi, gem, golang, maven, nuget, cargo)",
        }),
      ),
...
export function formatScore(jsonData: ArtifactData): string {
  ...
  if (jsonData.score && (jsonData.score as Record<string, unknown>)["overall"] !== undefined) {
