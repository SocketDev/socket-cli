...
export const reachabilityFlags: MeowFlags = {
  ...
  reachUseUnreachableFromPrecomputation: {
    type: "boolean",
    default: false,
    description: "Use unreachable information from precomputation to improve analysis accuracy.",
  },
  reachVersion: {
    type: "string",
    default: "",
    description: "Override the default @coana-tech/cli version used for reachability analysis.",
    hidden: true,
  },
};
