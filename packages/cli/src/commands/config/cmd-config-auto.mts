...
import { getSupportedConfigEntries, isSupportedConfigKey } from "../../util/config.mts";
...
const description = "Automatically discover and set the correct value config item";
...
${getSupportedConfigEntries()
  ...
  if (dryRun) {
    ...
    outputDryRunWrite(configPath, `auto-discover and set config value for "${key}"`, [
