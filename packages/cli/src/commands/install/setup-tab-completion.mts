...
> {
  ...
  const { completionCommand, sourcingCommand, targetPath, toAddToBashrc } = result.data;
...
export function updateInstalledTabCompletionScript(targetPath: string): CResult<undefined> {
