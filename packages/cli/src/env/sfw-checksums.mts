/**
 * SFW SHA-256 checksums getter function. Uses direct process.env access so
...
/**
 * Get SFW checksums from inlined environment variable. Returns a map of asset
...
/**
 * Lookup an SFW checksum by asset name. In production builds, throws if asset
