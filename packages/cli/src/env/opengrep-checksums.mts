/**
 * OpenGrep SHA-256 checksums getter function. Uses direct process.env access so
 * esbuild define can inline values. IMPORTANT: esbuild's define plugin can only
...
/**
 * Get OpenGrep checksums from inlined environment variable. Returns a map of
 * asset filename to SHA-256 hex checksum.
 */
...
/**
 * Lookup an OpenGrep checksum by asset name. In production builds, throws if
