 ...
 *
 * Usage: node .config/rolldown.build.mts        # all variants
 *        node .config/rolldown.build.mts cli     # CLI bundle
 *        node .config/rolldown.build.mts index   # entry point
 */
...
const VARIANTS = {
  ...
  string,
  {
    ...
    options: { envVars?: Record<string, string>; unicodeTransform?: boolean }
  }
>
