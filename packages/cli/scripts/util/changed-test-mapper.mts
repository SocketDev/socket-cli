...
function mapSourceToTests(filepath) {
  ...
  if (normalized.includes("src/commands/npm/cmd-npm.mts")) {
    return ["src/commands/npm/cmd-npm.test.mts", "src/commands/npm/cmd-npm-malware.test.mts"];
  }
  if (normalized.includes("src/commands/npx/cmd-npx.mts")) {
    return ["src/commands/npx/cmd-npx.test.mts", "src/commands/npx/cmd-npx-malware.test.mts"];
  }
  if (normalized.includes("src/commands/pnpm/cmd-pnpm.mts")) {
    return ["src/commands/pnpm/cmd-pnpm.test.mts", "src/commands/pnpm/cmd-pnpm-malware.test.mts"];
  }
  if (normalized.includes("src/commands/yarn/cmd-yarn.mts")) {
    return ["src/commands/yarn/cmd-yarn.test.mts", "src/commands/yarn/cmd-yarn-malware.test.mts"];
  }

  // Commands with smoke tests.
  if (normalized.includes("src/commands/login/cmd-login.mts")) {
    return ["src/commands/login/cmd-login.test.mts", "src/commands/login/cmd-login-smoke.test.mts"];
  }
  ...
  if (normalized.includes("src/commands/fix/cmd-fix.mts")) {
    return ["src/commands/fix/cmd-fix.test.mts", "src/commands/fix/cmd-fix-e2e.test.mts"];
  }
