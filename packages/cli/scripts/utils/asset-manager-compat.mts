 ...
 * Maintains existing API signatures from sea-build-utils/downloads.mts
 ...
 * Maintains exact API signature from sea-build-utils/downloads.mts.
 *
 ...
 * in sea-build-utils/downloads.mts. Future enhancement: move to AssetManager.
 *
