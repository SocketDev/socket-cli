 ...
 * - import { downloadBinject } from '../utils/asset-manager-compat.mts'
 *
 * These functions are now implemented in scripts/utils/asset-manager.mts
 * with backward-compatible wrappers in scripts/utils/asset-manager-compat.mts.
 *
