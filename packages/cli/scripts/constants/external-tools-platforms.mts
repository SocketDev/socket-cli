...
export const PLATFORM_MAP_TOOLS = {
  ...
  "linux-arm64": {
    ...
    python: "cpython-3.11.14+20260203-aarch64-unknown-linux-gnu-install_only.tar.gz",
  ...
  "linux-arm64-musl": {
    __proto__: null,
    opengrep: "opengrep-core_linux_aarch64.tar.gz",
    python: "cpython-3.11.14+20260203-aarch64-unknown-linux-musl-install_only.tar.gz",
  ...
  "linux-x64": {
    ...
    python: "cpython-3.11.14+20260203-x86_64-unknown-linux-gnu-install_only.tar.gz",
  ...
  "linux-x64-musl": {
    __proto__: null,
    opengrep: "opengrep-core_linux_x86.tar.gz",
    python: "cpython-3.11.14+20260203-x86_64-unknown-linux-musl-install_only.tar.gz",
  ...
  "win-arm64": {
    ...
    python: "cpython-3.11.14+20260203-aarch64-pc-windows-msvc-install_only.tar.gz", // native arm64.
  ...
  "win-x64": {
    ...
    python: "cpython-3.11.14+20260203-x86_64-pc-windows-msvc-install_only.tar.gz",
