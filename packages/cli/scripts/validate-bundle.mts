...
async function main() {
  try {
    ...
    logger.log("These require() calls reference relative paths that will fail at runtime.");
    logger.log("Socket-lib external dependencies should be bundled into the CLI.");
    logger.log("");
