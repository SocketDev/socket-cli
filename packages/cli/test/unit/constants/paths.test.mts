...
describe("paths constants", () => {
  ...
  describe("path getter functions", () => {
    ...
    it("getBinCliPath returns path to CLI entry point", () => {
      ...
      const isOverride = result.endsWith("build/cli.js") || result.endsWith("build\\cli.js");
      const isDefault = result.endsWith("dist/index.js") || result.endsWith("dist\\index.js");
  ...
  describe("getSocketCachePath", () => {
    ...
    it("respects XDG_CACHE_HOME when set", async () => {
      ...
      const { getSocketCachePath: getPathFresh } = await import("../../../src/constants/paths.mts");
  ...
  describe("getSocketAppDataPath", () => {
    it("returns a string or undefined", async () => {
      const { getSocketAppDataPath } = await import("../../../src/constants/paths.mts");
  ...
  describe("getSocketRegistryPath", () => {
    it("returns a path containing registry", async () => {
      const { getSocketRegistryPath } = await import("../../../src/constants/paths.mts");
      try {
  ...
  describe("getNmNodeGypPath", () => {
    it("returns string or undefined", async () => {
      const { getNmNodeGypPath } = await import("../../../src/constants/paths.mts");
