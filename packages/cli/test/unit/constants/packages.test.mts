...
describe("packages constants", () => {
  ...
  describe("Socket CLI package name constants", () => {
    ...
    it("has SOCKET_CLI_SENTRY_PACKAGE_NAME constant", () => {
      expect(SOCKET_CLI_SENTRY_PACKAGE_NAME).toBe("@socketsecurity/cli-with-sentry");
    });
  });
  ...
  describe("Socket CLI Sentry binary name constants", () => {
    ...
    it("has SOCKET_CLI_SENTRY_NPM_BIN_NAME constant", () => {
      expect(SOCKET_CLI_SENTRY_NPM_BIN_NAME).toBe("@socketsecurity/cli-with-sentry-npm");
    });

    it("has SOCKET_CLI_SENTRY_NPX_BIN_NAME constant", () => {
      expect(SOCKET_CLI_SENTRY_NPX_BIN_NAME).toBe("@socketsecurity/cli-with-sentry-npx");
    });

    it("has SOCKET_CLI_SENTRY_PNPM_BIN_NAME constant", () => {
      expect(SOCKET_CLI_SENTRY_PNPM_BIN_NAME).toBe("@socketsecurity/cli-with-sentry-pnpm");
    });

    it("has SOCKET_CLI_SENTRY_YARN_BIN_NAME constant", () => {
      expect(SOCKET_CLI_SENTRY_YARN_BIN_NAME).toBe("@socketsecurity/cli-with-sentry-yarn");
    });
  });
