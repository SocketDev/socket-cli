...
describe("fix/git utilities", () => {
  describe("getUniquePackages", () => {
    ...
    it("treats same name in different ecosystems as distinct", () => {
      ...
      expect(getUniquePackages(details)).toEqual(["requests (PIP)", "requests (NPM)"]);
    });
  ...
  describe("getSocketFixBranchName", () => {
    it("returns correct branch name format", () => {
      expect(getSocketFixBranchName("GHSA-1234-5678-9abc")).toBe("socket/fix/GHSA-1234-5678-9abc");
    });

    it("handles lowercase GHSA IDs", () => {
      expect(getSocketFixBranchName("ghsa-abcd-efgh-ijkl")).toBe("socket/fix/ghsa-abcd-efgh-ijkl");
    });
  });
  ...
  describe("getSocketFixCommitMessage", () => {
    it("returns basic commit message without details", () => {
      expect(getSocketFixCommitMessage("GHSA-1234-5678-9abc")).toBe("fix: GHSA-1234-5678-9abc");
    });
  ...
  describe("getSocketFixPullRequestTitle", () => {
    ...
    it("returns multiple GHSAs title", () => {
      expect(getSocketFixPullRequestTitle(["GHSA-1111-2222-3333", "GHSA-4444-5555-6666"])).toBe(
        "Fixes for 2 GHSAs",
      );
    });
  ...
  describe("getSocketFixPullRequestBody", () => {
    ...
    it("returns list format for multiple GHSAs", () => {
      const body = getSocketFixPullRequestBody(["GHSA-1111-2222-3333", "GHSA-4444-5555-6666"]);
