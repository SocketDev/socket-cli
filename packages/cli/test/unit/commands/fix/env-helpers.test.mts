 ...
 *
 * Related Files: - src/commands/fix/ci-environment.mts - Environment variable
...
import {
  ...
  getFixEnv,
} from '../../../../src/commands/fix/ci-environment.mts'
...
vi.mock(
  import('../../../../src/env/socket-cli-git-user-email.mts'),
  () => mockGitEmail,
)
...
vi.mock(
  import('../../../../src/env/socket-cli-git-user-name.mts'),
  () => mockGitUser,
)
...
vi.mock(
  import('../../../../src/env/github-repository.mts'),
  () => mockGithubRepo,
)
