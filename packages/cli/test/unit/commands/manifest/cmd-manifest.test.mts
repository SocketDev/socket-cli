...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-auto.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-cdxgen.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-conda.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-gradle.mts'),
  () => ({
    cmdManifestGradle: {
...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-kotlin.mts'),
  () => ({
    cmdManifestKotlin: {
...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-scala.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/manifest/cmd-manifest-setup.mts'),
  () => ({
