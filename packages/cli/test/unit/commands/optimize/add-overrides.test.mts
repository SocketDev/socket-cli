...
vi.mock(
  import('../../../../src/commands/optimize/get-dependency-entries.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/optimize/get-overrides-by-agent.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/optimize/lockfile-includes-by-agent.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/optimize/deps-includes-by-agent.mts'),
  () => ({
...
vi.mock(
  import('../../../../src/commands/optimize/update-manifest-by-agent.mts'),
  () => ({
