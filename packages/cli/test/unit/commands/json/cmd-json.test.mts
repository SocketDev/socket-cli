...
vi.mock(import("../../../../src/commands/json/handle-cmd-json.mts"), () => ({
...
describe("cmd-json", () => {
  ...
  describe("run", () => {
    ...
    it("should call handleCmdJson with relative path resolved against cwd", async () => {
      ...
      expect(mockHandleCmdJson).toHaveBeenCalledWith("/Users/test/project/subdir");
    });
    ...
    it("should handle nested relative paths", async () => {
      ...
      expect(mockHandleCmdJson).toHaveBeenCalledWith("/Users/test/project/foo/bar/baz");
    });
    ...
    it("should handle readonly argv array", async () => {
      ...
      expect(mockHandleCmdJson).toHaveBeenCalledWith("/Users/test/project/target");
    });
    ...
    it("should handle paths with special characters", async () => {
      ...
      expect(mockHandleCmdJson).toHaveBeenCalledWith("/Users/test/project/my-project");
    });
