...
vi.mock(import("../../../../src/util/cli/with-subcommands.mts"), async (importOriginal) => {
...
// Import after mocks.
const { cmdPatch, CMD_NAME } = await import("../../../../src/commands/patch/cmd-patch.mts");
...
describe("cmd-patch", () => {
  ...
  describe("subcommand forwarding", () => {
    ...
    it("should forward download subcommand with purl", async () => {
      await cmdPatch.run(["download", "pkg:npm/lodash@4.17.21"], importMeta, context);
