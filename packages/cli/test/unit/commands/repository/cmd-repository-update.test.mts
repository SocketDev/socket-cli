...
vi.mock(import("../../../../src/commands/repository/handle-update-repo.mts"), () => ({
...
describe("cmd-repository-update", () => {
  ...
  describe("run", () => {
    ...
    it("should support --dry-run flag", async () => {
      ...
      await cmdRepositoryUpdate.run(["test-repo", "--dry-run"], importMeta, context);
    ...
    it("should fail without Socket API token", async () => {
      ...
      await cmdRepositoryUpdate.run(["test-repo", "--no-interactive"], importMeta, context);
    ...
    it("should show repository details in dry-run mode", async () => {
      ...
      await cmdRepositoryUpdate.run(["my-repo", "--dry-run"], importMeta, context);
    ...
    it("should pass interactive flag to determineOrgSlug", async () => {
      ...
      await cmdRepositoryUpdate.run(["test-repo", "--interactive"], importMeta, context);
