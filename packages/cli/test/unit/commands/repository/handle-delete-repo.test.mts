...
vi.mock(import("../../../../src/commands/repository/fetch-delete-repo.mts"), () => ({
  fetchDeleteRepo: mockFetchDeleteRepo,
}));

vi.mock(import("../../../../src/commands/repository/output-delete-repo.mts"), () => ({
...
describe("handleDeleteRepo", () => {
  ...
  it("handles deletion failure", async () => {
    ...
    expect(mockOutputDeleteRepo).toHaveBeenCalledWith(mockResult, "nonexistent-repo", "text");
  });
  ...
  it("handles markdown output format", async () => {
    ...
    expect(mockOutputDeleteRepo).toHaveBeenCalledWith(expect.any(Object), "my-repo", "markdown");
  });

  it("handles different repository names", async () => {
    const repoNames = ["simple-repo", "repo-with-dashes", "repo_with_underscores", "repo123"];
