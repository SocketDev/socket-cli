...
vi.mock(import("../../../../src/commands/repository/handle-list-repos.mts"), () => ({
...
describe("cmd-repository-list", () => {
  ...
  describe("run", () => {
    ...
    it("should pass --all flag to handleListRepos", async () => {
      ...
      await cmdRepositoryList.run(["--all", "--no-interactive"], importMeta, context);
    ...
    it("should pass --page flag to handleListRepos", async () => {
      ...
      await cmdRepositoryList.run(["--page", "2", "--no-interactive"], importMeta, context);
    ...
    it("should pass --per-page flag to handleListRepos", async () => {
      ...
      await cmdRepositoryList.run(["--per-page", "50", "--no-interactive"], importMeta, context);
    ...
    it("should pass --direction flag to handleListRepos", async () => {
      ...
      await cmdRepositoryList.run(["--direction", "asc", "--no-interactive"], importMeta, context);
    ...
    it("should pass --org flag to determineOrgSlug", async () => {
      ...
      await cmdRepositoryList.run(["--org", "custom-org", "--no-interactive"], importMeta, context);
    ...
    it("should pass --json flag to handleListRepos", async () => {
      ...
      await cmdRepositoryList.run(["--json", "--no-interactive"], importMeta, context);
    ...
    it("should pass --markdown flag to handleListRepos", async () => {
      ...
      await cmdRepositoryList.run(["--markdown", "--no-interactive"], importMeta, context);
    ...
    it("should show query parameters in dry-run mode with default values", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining("sort: created_at"));
      expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining("direction: desc"));
      expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining("page: 1"));
      expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining("perPage: 30"));
    });
    ...
    it("should show query parameters in dry-run mode with --all flag", async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining("all: true"));
    });
