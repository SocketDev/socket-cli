...
vi.mock(import("../../../../src/commands/audit-log/fetch-audit-log.mts"), () => ({
  fetchAuditLog: mockFetchAuditLog,
}));
vi.mock(import("../../../../src/commands/audit-log/output-audit-log.mts"), () => ({
...
describe("handleAuditLog", () => {
  ...
  it("handles markdown output", async () => {
    ...
    const mockLogs = createSuccessResult([{ id: 1, type: "config", message: "Config change" }]);
    mockFetchAuditLog.mockResolvedValue(mockLogs);
