...
vi.mock(import("../../../../src/commands/organization/handle-license-policy.mts"), () => ({
...
describe("cmd-organization-policy-license", () => {
  ...
  describe("run", () => {
    ...
    it("should fail without Socket API token", async () => {
      ...
      await cmdOrganizationPolicyLicense.run(["--no-interactive"], importMeta, context);
    ...
    it("should pass --json flag to handleLicensePolicy", async () => {
      ...
      await cmdOrganizationPolicyLicense.run(["--json", "--no-interactive"], importMeta, context);
    ...
    it("should pass interactive flag to determineOrgSlug", async () => {
      ...
      await cmdOrganizationPolicyLicense.run(["--interactive"], importMeta, context);
