...
vi.mock(import("../../../../src/commands/organization/handle-security-policy.mts"), () => ({
...
describe("cmd-organization-policy-security", () => {
  ...
  describe("run", () => {
    ...
    it("should support --dry-run flag", async () => {
      ...
      await cmdOrganizationPolicySecurity.run(["--dry-run"], importMeta, context);
    ...
    it("should fail without Socket API token", async () => {
      ...
      await cmdOrganizationPolicySecurity.run(["--no-interactive"], importMeta, context);
    ...
    it("should pass --json flag to handleSecurityPolicy", async () => {
      ...
      await cmdOrganizationPolicySecurity.run(["--json", "--no-interactive"], importMeta, context);
    ...
    it("should pass interactive flag to determineOrgSlug", async () => {
      ...
      await cmdOrganizationPolicySecurity.run(["--interactive"], importMeta, context);
