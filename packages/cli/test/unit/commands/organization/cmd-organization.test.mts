...
describe("cmd-organization", () => {
  ...
  describe("command metadata", () => {
    it("should have correct description", () => {
      expect(cmdOrganization.description).toBe("Manage Socket organization account details");
    });
  ...
  describe("subcommand routing", () => {
    ...
    it("should include all subcommands", async () => {
      ...
      expect(Object.keys(subcommands)).toEqual(["dependencies", "list", "quota", "policy"]);
    });
  ...
  describe("subcommand validation", () => {
    it("should reference correct subcommand objects", async () => {
      ...
      await cmdOrganization.run([], { url: "file:///test" }, { parentName: "socket" });
  ...
  describe("error handling", () => {
    it("should propagate errors from meowWithSubcommands", async () => {
      ...
      await expect(
        cmdOrganization.run([], { url: "file:///test" }, { parentName: "socket" }),
  ...
  describe("options configuration", () => {
    it("should pass description in options", async () => {
      ...
      expect(options.description).toBe("Manage Socket organization account details");
    });
  });
});
