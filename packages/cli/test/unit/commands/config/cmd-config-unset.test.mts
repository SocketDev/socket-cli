...
vi.mock(import("../../../../src/commands/config/handle-config-unset.mts"), () => ({
...
describe("cmd-config-unset", () => {
  ...
  describe("command metadata", () => {
    ...
    it("should have correct description", () => {
      expect(cmdConfigUnset.description).toBe("Clear the value of a local CLI config item");
    });
  ...
  describe("run", () => {
    ...
    describe("--dry-run flag", () => {
      it("should show preview without calling handler", async () => {
        await cmdConfigUnset.run(["defaultOrg", "--dry-run"], importMeta, context);
    ...
    describe("output formats", () => {
      ...
      it("should pass markdown output kind when --markdown flag provided", async () => {
        ...
        await cmdConfigUnset.run(["defaultOrg", "--markdown"], importMeta, context);
    ...
    describe("flag validation", () => {
      it("should validate that --json and --markdown are not used together", async () => {
        await cmdConfigUnset.run(["defaultOrg", "--json", "--markdown"], importMeta, context);
    ...
    describe("edge cases", () => {
      ...
      it("should ignore extra arguments after key", async () => {
        await cmdConfigUnset.run(["apiToken", "extra", "args"], importMeta, context);
    ...
    describe("comparison with set command", () => {
      ...
      it("should ignore any value-like arguments provided", async () => {
        await cmdConfigUnset.run(["apiToken", "this-looks-like-value"], importMeta, context);
