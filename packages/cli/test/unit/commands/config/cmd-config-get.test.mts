 ...
 * config utilities (isSupportedConfigKey, getSupportedConfigEntries) - Mock
 * dry-run output utilities - Mock output mode utilities - Mock validation
 * utilities.
 *
 * Related Files: - src/commands/config/cmd-config-get.mts - Implementation -
...
vi.mock(import("../../../../src/commands/config/handle-config-get.mts"), () => ({
...
// Import after mocks.
const { cmdConfigGet } = await import("../../../../src/commands/config/cmd-config-get.mts");
...
describe("cmd-config-get", () => {
  ...
  describe("command metadata", () => {
    it("should have correct description", () => {
      expect(cmdConfigGet.description).toBe("Get the value of a local CLI config item");
    });
  ...
  describe("run", () => {
    ...
    describe("output formats", () => {
      ...
      it("should pass markdown output kind when --markdown flag provided", async () => {
        ...
        await cmdConfigGet.run(["defaultOrg", "--markdown"], importMeta, context);
    ...
    describe("flag validation", () => {
      it("should validate that --json and --markdown are not used together", async () => {
        await cmdConfigGet.run(["defaultOrg", "--json", "--markdown"], importMeta, context);
    ...
    describe("edge cases", () => {
      ...
      it("should handle multiple arguments and only use first as key", async () => {
        await cmdConfigGet.run(["apiToken", "extra", "args"], importMeta, context);
