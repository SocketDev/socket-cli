...
// Import after mocks.
const { cmdConfig } = await import("../../../../src/commands/config/cmd-config.mts");
const { cmdConfigAuto } = await import("../../../../src/commands/config/cmd-config-auto.mts");
...
const { cmdConfigSet } = await import("../../../../src/commands/config/cmd-config-set.mts");
const { cmdConfigUnset } = await import("../../../../src/commands/config/cmd-config-unset.mts");
...
describe("cmd-config", () => {
  ...
  describe("subcommand routing", () => {
    ...
    it("should include all subcommands", async () => {
      ...
      expect(Object.keys(subcommands)).toEqual(["auto", "get", "list", "set", "unset"]);
    });
