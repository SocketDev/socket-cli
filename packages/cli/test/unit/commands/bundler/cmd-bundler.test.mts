...
// Import after mocks.
const { cmdBundler } = await import("../../../../src/commands/bundler/cmd-bundler.mts");
...
describe("cmd-bundler", () => {
  ...
  describe("command metadata", () => {
    it("should have correct description", () => {
      expect(cmdBundler.description).toBe("Run bundler with Socket Firewall security");
    });
  ...
  describe("run", () => {
    ...
    describe("flag filtering", () => {
      it("should filter out Socket CLI flags and forward bundler flags", async () => {
        ...
        expect(mockSpawnSfwDlx).toHaveBeenCalledWith(["bundler", "install", "--jobs", "4"], {
          stdio: "inherit",
        });
      });
    });
