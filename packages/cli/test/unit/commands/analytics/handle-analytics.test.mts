...
vi.mock(
  import('../../../../src/commands/analytics/fetch-org-analytics.mts'),
  () => ({
    fetchOrgAnalyticsData: mockFetchOrgAnalyticsData,
  }),
)
vi.mock(
  import('../../../../src/commands/analytics/fetch-repo-analytics.mts'),
  () => ({
    fetchRepoAnalyticsData: mockFetchRepoAnalyticsData,
  }),
)
vi.mock(
  import('../../../../src/commands/analytics/output-analytics.mts'),
  () => ({
