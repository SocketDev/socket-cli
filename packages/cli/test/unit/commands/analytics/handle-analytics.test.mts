...
vi.mock(import("../../../../src/commands/analytics/fetch-org-analytics.mts"), () => ({
  fetchOrgAnalyticsData: mockFetchOrgAnalyticsData,
}));
vi.mock(import("../../../../src/commands/analytics/fetch-repo-analytics.mts"), () => ({
  fetchRepoAnalyticsData: mockFetchRepoAnalyticsData,
}));
vi.mock(import("../../../../src/commands/analytics/output-analytics.mts"), () => ({
...
describe("handleAnalytics", () => {
  ...
  it("fetches org analytics when scope is org", async () => {
    ...
    expect(outputAnalytics).toHaveBeenCalledWith(createSuccessResult(mockData), {
      filepath: "/tmp/analytics.json",
      outputKind: "json",
      repo: "",
      scope: "org",
  ...
  it("passes through fetch errors", async () => {
    ...
    expect(outputAnalytics).toHaveBeenCalledWith(errorResult, expect.any(Object));
  });
