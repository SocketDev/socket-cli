...
describe("outputDiffScan", () => {
  ...
  describe("JSON output mode", () => {
    it("outputs JSON to stdout", async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalled();
      expect(mockLogger.info).toHaveBeenCalledWith(expect.stringContaining("Diff scan result"));
    });
    ...
    it("writes JSON to file", async () => {
      ...
      expect(mockWriteFile).toHaveBeenCalledWith("output.json", expect.any(String), "utf8");
    ...
    it("handles file write error", async () => {
      ...
      expect(mockLogger.fail).toHaveBeenCalledWith(expect.stringContaining("failed"));
  ...
  describe("markdown output mode", () => {
    it("outputs markdown header", async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining("Scan diff result"));
    });
    ...
    it("outputs added packages", async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining("lodash@4.17.21"));
    });
    ...
    it("truncates removed package list when over 10", async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining("and 2 more"));
    });
    ...
    it("truncates package lists longer than 10", async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining("and 5 more"));
    });
    ...
    it("outputs scan metadata", async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining("Scan scan-before"));
      expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining("Scan scan-after"));
    });
  ...
  describe("text output mode", () => {
    it("outputs inspect result", async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(expect.stringContaining("--json flag"));
    });
    ...
    it("includes dashboard message", async () => {
      ...
      expect(mockLogger.info).toHaveBeenCalledWith(expect.stringContaining("socket.dev/diff/123"));
    });
