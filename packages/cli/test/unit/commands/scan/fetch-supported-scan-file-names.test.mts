...
describe("fetchSupportedScanFileNames", () => {
  it("fetches supported scan file names successfully", async () => {
    ...
    const { mockHandleApi, mockSdk } = await setupSdkMockSuccess("getSupportedFiles", mockData);
  ...
  it("passes custom SDK options", async () => {
    ...
    const { mockSdk, mockSetupSdk } = await setupSdkMockSuccess("getSupportedFiles", {});
  ...
  it("works with orgSlug provided", async () => {
    ...
    const { mockHandleApi, mockSetupSdk } = await setupSdkMockSuccess("getSupportedFiles", {
