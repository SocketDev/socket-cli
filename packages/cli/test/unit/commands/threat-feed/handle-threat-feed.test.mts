...
import { handleThreatFeed } from '../../../../../src/commands/../../../../src/commands/threat-feed/handle-threat-feed.mts'

// Mock the dependencies.
vi.mock('../../../../../src/commands/../../../../src/commands/threat-feed/fetch-threat-feed.mts', () => ({
  fetchThreatFeed: vi.fn(),
}))
vi.mock('../../../../../src/commands/../../../../src/commands/threat-feed/output-threat-feed.mts', () => ({
...
describe('handleThreatFeed', () => {
  ...
  it('fetches and outputs threat feed successfully', async () => {
    const { fetchThreatFeed } = await import('../../../../../src/commands/../src/fetch-threat-feed.mts')
    const { outputThreatFeed } = await import('../../../../../src/commands/../src/output-threat-feed.mts')
