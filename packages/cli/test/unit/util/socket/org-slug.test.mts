...
vi.mock(import("../../../../src/constants/config.mjs"), async (importOriginal) => {
...
vi.mock(import("../../../../src/constants/socket.mts"), () => ({
  V1_MIGRATION_GUIDE_URL: "https://socket.dev/migration-guide",
}));

vi.mock(import("../../../../src/util/terminal/link.mjs"), () => ({
  webLink: mockWebLink,
}));

vi.mock(import("../../../../src/commands/scan/suggest-org-slug.mjs"), () => ({
  suggestOrgSlug: mockSuggestOrgSlug,
}));

vi.mock(import("../../../../src/commands/scan/suggest-to-persist-orgslug.mjs"), () => ({
...
describe("determineOrgSlug", () => {
  ...
  describe("when using default org", () => {
    it("uses default org when no flag provided", async () => {
      ...
      expect(result).toEqual(["configured-default-org", "configured-default-org"]);
    });
