 ...
 *
 * Purpose: Tests output formatting utilities. Validates table formatting,
 * column alignment, and text wrapping.
 *
 * Test Coverage: - Table formatting - Column alignment - Text wrapping -
 * Truncation - Border styles - Color coding.
 *
 * Testing Approach: Tests text formatting utilities for CLI output.
 *
 * Related Files: - util/output/formatting.mts (implementation)
 */
...
import {
  ...
  getFlagsHelpOutput,
  getHelpListOutput,
} from "../../../../src/util/output/formatting.mts";

// Mock requirements module.
vi.mock(import("../../../../src/util/ecosystem/requirements.mts"), () => ({
  ...
  describe("getFlagApiRequirementsOutput", () => {
    it("formats API requirements with quota and permissions", async () => {
      const { getRequirements, getRequirementsKey } = vi.mocked(
        await import("../../../../src/util/ecosystem/requirements.mts"),
      );
