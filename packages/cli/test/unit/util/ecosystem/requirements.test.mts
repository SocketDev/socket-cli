 ...
 *
 * Purpose: Tests ecosystem requirements checking. Validates minimum version
 * requirements and compatibility.
 *
 * Test Coverage: - Version requirement parsing - Compatibility checking -
 * Minimum version validation - Range support (semver) - Error messaging for
 * incompatible versions.
 *
 * Testing Approach: Tests semver-based requirement validation logic.
 *
 * Related Files: - util/ecosystem/requirements.mts (implementation)
 */
...
import {
  getRequirements,
  getRequirementsKey,
} from '../../../../src/util/ecosystem/requirements.mts'

// Mock the requirements.json module.
vi.mock(import('../../../../src/util/ecosystem/requirements.json'), () => ({
  default: {
    api: {
      'scan:create': {
        quota: 10,
