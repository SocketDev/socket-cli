/**
 * Unit tests for detectPackageEnvironment.
 *
...
import { detectPackageEnvironment } from '../../../../src/util/ecosystem/environment.mts'
...
vi.mock(
  ...
  async importOriginal => {
    ...
    return {
      ...
      getPnpmExecPath: mockGetPnpmExecPath.mockResolvedValue(
        '/usr/local/bin/pnpm',
      ),
    }
  },
