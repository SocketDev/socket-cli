...
vi.mock(import("../../../../src/env/socket-cli-coana-local-path.mts"), () => mockCoanaLocalPath);
vi.mock(import("../../../../src/env/socket-cli-cdxgen-local-path.mts"), () => mockCdxgenLocalPath);
vi.mock(import("../../../../src/env/socket-cli-pycli-local-path.mts"), () => mockPyCliLocalPath);
vi.mock(import("../../../../src/env/socket-cli-sfw-local-path.mts"), () => mockSfwLocalPath);
vi.mock(
...
describe("binary resolution utilities", () => {
  ...
  describe("resolveCoana", () => {
    it("returns dlx spec when no local path is set", async () => {
      const { resolveCoana } = await import("../../../../src/util/dlx/resolve-binary.mts");
  ...
  describe("resolveCdxgen", () => {
    it("returns dlx spec when no local path is set", async () => {
      const { resolveCdxgen } = await import("../../../../src/util/dlx/resolve-binary.mts");
  ...
  describe("resolvePyCli", () => {
    it("returns python type when no local path is set", async () => {
      const { resolvePyCli } = await import("../../../../src/util/dlx/resolve-binary.mts");
  ...
  describe("resolveSfw", () => {
    it("returns dlx spec when no local path is set", async () => {
      const { resolveSfw } = await import("../../../../src/util/dlx/resolve-binary.mts");
  ...
  describe("resolveSocketPatch", () => {
    it("returns github-release spec for darwin-arm64", async () => {
      ...
      const { resolveSocketPatch } = await import("../../../../src/util/dlx/resolve-binary.mts");
    ...
    it("returns local path when SOCKET_CLI_SOCKET_PATCH_LOCAL_PATH is set", async () => {
      mockSocketPatchLocalPath.SOCKET_CLI_SOCKET_PATCH_LOCAL_PATH = "/custom/path/socket-patch";
  ...
  describe("resolveTrivy", () => {
    it.each([
      ...
      const { resolveTrivy } = await import("../../../../src/util/dlx/resolve-binary.mts");
    ...
    it("throws on unsupported platform", async () => {
      ...
      expect(() => resolveTrivy()).toThrow(/Trivy has no prebuilt binary for "win32-arm64"/);
    });
  });
  ...
  describe("resolveTrufflehog", () => {
    it.each([
      ...
      const { resolveTrufflehog } = await import("../../../../src/util/dlx/resolve-binary.mts");
  ...
  describe("resolveOpengrep", () => {
    it.each([
      ...
      const { resolveOpengrep } = await import("../../../../src/util/dlx/resolve-binary.mts");
    ...
    it("throws on unsupported platform", async () => {
      ...
      expect(() => resolveOpengrep()).toThrow(/OpenGrep has no prebuilt binary for "win32-arm64"/);
    });
  });
});
