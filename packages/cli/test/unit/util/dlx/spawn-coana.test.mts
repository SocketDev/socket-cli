...
import { spawnCoana, spawnCoanaDlx, spawnCoanaVfs } from "../../../../src/util/dlx/spawn-coana.mts";
...
describe("spawnCoanaDlx", () => {
  ...
  it("runs the local coana.js via node when not a binary", async () => {
    ...
    expect(mockSpawn).toHaveBeenCalledWith("node", ["/local/coana.js"], expect.any(Object));
  });
...
describe("spawnCoanaVfs", () => {
  ...
  it("spawns coana through spawnToolVfs and returns stdout", async () => {
    ...
    expect(mockSpawnToolVfs).toHaveBeenCalledWith("coana", ["args"], expect.any(Object), undefined);
