...
vi.mock('../../../../src/util/basics/vfs-extract.mts', () => ({
...
vi.mock('../../../../src/util/spawn/spawn-node.mts', () => ({
...
vi.mock('../../../../src/env/pycli-checksums.mts', () => ({
...
vi.mock('../../../../src/env/python-build-tag.mts', () => ({
  getPythonBuildTag: mockGetPythonBuildTag,
}))

vi.mock('../../../../src/env/python-checksums.mts', () => ({
