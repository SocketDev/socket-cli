 ...
 *
 * Purpose: Tests terminal color utilities. Validates ANSI color code generation
 * and NO_COLOR support.
 *
 * Test Coverage:
 *
 * - ANSI color codes
 ...
 * - Color stripping
 *
 * Special Notes: Uses yoctocolors-cjs package for colors.
 *
 * Testing Approach: Tests color utilities with environment mocking.
 *
 * Related Files:
 *
 * - Util/terminal/colors.mts (implementation)
 */
...
import {
  ColorOrMarkdown,
  colorOrMarkdown,
} from '../../../../src/util/terminal/colors.mts'
