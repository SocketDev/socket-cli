...
describe("scrubSnapshotData", () => {
  describe("timestamps", () => {
    it("should scrub ISO timestamps", () => {
      const input = "Created at 2025-04-02T01:47:26.914Z and updated 2025-03-31T15:19:55.299Z";
    ...
    it("should scrub relative time expressions", () => {
      const input = "Updated 2 days ago, created 5 minutes ago, and modified 1 hour ago";
      const result = scrubSnapshotData(input);
      expect(result).toBe(
  ...
  describe("paths", () => {
    it("should scrub Unix home directories", () => {
      ...
      const result = scrubSnapshotData(input);
      expect(result).toBe("/[HOME]/projects/other-project and /[HOME]/documents/file.txt");
    });
    ...
    it("should scrub Windows home directories", () => {
      const input = "C:\\Users\\jdalton\\projects and C:\\Users\\TestUser\\Documents";
      const result = scrubSnapshotData(input);
    ...
    it("should scrub Unix temp directories", () => {
      const input = "Temp files in /tmp/socket-test-12345 and /tmp/build-abc_123";
      const result = scrubSnapshotData(input);
  ...
  describe("custom patterns", () => {
    it("should apply custom scrubbing patterns", () => {
      ...
      const result = scrubSnapshotData(input, {
        custom: [{ pattern: /[a-z]{3}-\d{3}-[a-z]{3}/g, replacement: "[CUSTOM_KEY]" }],
      });
