 ...
 *   `packages/cli/test/smoke.sh`'s analytics section (19 commands).
 *
 *   Covers: default invocation / explicit scopes (org, repo, time-window),
 *   markdown + JSON output paths, --file output, and error-path checks for
 *   unknown flags / unknown scopes / unknown repos.
 *
