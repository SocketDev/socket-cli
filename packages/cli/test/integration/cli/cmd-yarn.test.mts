...
import { FLAG_CONFIG, FLAG_DRY_RUN, FLAG_HELP, FLAG_QUIET } from "../../../src/constants/cli.mts";
...
describe("socket yarn", async () => {
  cmdit([YARN, FLAG_HELP, FLAG_CONFIG, "{}"], `should support ${FLAG_HELP}`, async (cmd) => {
  ...
  cmdit(
    ["yarn", "add", "lodash", FLAG_DRY_RUN, FLAG_CONFIG, '{"apiToken":"fakeToken"}'],
  ...
  cmdit(
    ["yarn", "add", "@types/node@^20.0.0", FLAG_DRY_RUN, FLAG_CONFIG, '{"apiToken":"fakeToken"}'],
