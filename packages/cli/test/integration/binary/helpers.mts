 ...
 */
export async function buildBinary(binary: BinaryConfig, binaryType: string): Promise<boolean> {
 ...
 */
export async function prepareBinary(binary: BinaryConfig, binaryType: string): Promise<boolean> {
