...
/**
 * @file Integration tests for JS Distribution binary.
 */
...
const BINARY: BinaryConfig = {
  ...
  enabled: process.env.CI
    ? true
    : !process.env.TEST_SEA_BINARY && !process.env.TEST_SMOL_BINARY && !process.env.TEST_JS_BINARY
      ? true
...
if (BINARY.enabled) {
  describe(BINARY.name, () => {
    ...
    beforeAll(async () => {
      binaryExists = await prepareBinary(BINARY, "js");
      ...
      if (ENV.RUN_INTEGRATION_TESTS) {
        ...
        if (!apiToken && !process.env.CI) {
          ...
          logger.log("  3. Skip integration tests by not setting RUN_INTEGRATION_TESTS");
          logger.log("");
          logger.log("Integration tests will be skipped due to missing authentication.");
          logger.log("");
        }
      }
    });
    describe("Basic commands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display version", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display package command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display optimize command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display fix command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display npm command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display pnpm exec command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display patch command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display config command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display repository command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display pnpm command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display yarn command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display pip command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display wrapper command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display install command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display uninstall command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display login command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display logout command help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display whoami command help", async () => {
        if (!binaryExists) {
          return;
        }
    ...
    describe("Scan subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan create help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan list help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan view help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan del help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan diff help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan metadata help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan report help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan setup help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan github help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display scan reach help", async () => {
        if (!binaryExists) {
          return;
        }
    ...
    describe("Config subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display config get help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display config set help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display config unset help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display config list help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display config auto help", async () => {
        if (!binaryExists) {
          return;
        }
    ...
    describe("Organization subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display organization list help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display organization quota help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display organization policy help", async () => {
        if (!binaryExists) {
          return;
        }
    ...
    describe("Repository subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display repository create help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["repository", "create", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display repository list help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["repository", "list", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display repository view help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["repository", "view", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display repository update help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["repository", "update", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display repository del help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["repository", "del", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
    ...
    describe("Patch subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display patch list help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display patch get help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display patch scan help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display patch repair help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["patch", "repair", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display patch remove help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["patch", "remove", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
    ...
    describe("Manifest subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest auto help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest conda help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest gradle help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest kotlin help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest scala help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display manifest setup help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["manifest", "setup", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle manifest cdxgen command", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["manifest", "cdxgen", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
    ...
    describe("Package subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display package score help", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display package shallow help", async () => {
        if (!binaryExists) {
          return;
        }
    ...
    describe("Install/Uninstall subcommands (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display install completion help", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["install", "completion", "--help"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["uninstall", "completion", "--help"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
    ...
    describe("Dry-run validation (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle optimize --dry-run", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["optimize", "--dry-run", "--config", "{}"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle fix --dry-run", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["fix", "--dry-run", "--config", "{}"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle npm --dry-run", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["npm", "install", "--dry-run", "--config", "{}"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
    ...
    describe("Auth-required commands", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should list config settings", async () => {
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should display whoami information", async () => {
        if (!binaryExists || !hasAuth) {
          return;
        }
    ...
    describe("Error handling - missing arguments (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["scan", "create", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["scan", "view", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should error on config get without key", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["config", "get", "--config", "{}"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["config", "set", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["patch", "get", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["package", "score", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["repository", "create", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["repository", "view", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
    ...
    describe("JSON output format validation (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["scan", "list", "--json", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["config", "list", "--json", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["patch", "list", "--json", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
    ...
    describe("Markdown output format validation (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)(
        ...
        async () => {
          ...
          const result = await executeCliCommand(["scan", "list", "--markdown", "--config", "{}"], {
            binPath: BINARY.path,
            isolateConfig: false,
          });
    ...
    describe("Additional dry-run tests (no auth required)", () => {
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle scan create --dry-run", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle patch download --dry-run", async () => {
        if (!binaryExists) {
          return;
        }
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle pnpm exec --dry-run", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["npx", "--dry-run", "--config", "{}", "cowsay"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle pnpm --dry-run", async () => {
        if (!binaryExists) {
          return;
        }

        const result = await executeCliCommand(["pnpm", "install", "--dry-run", "--config", "{}"], {
          binPath: BINARY.path,
          isolateConfig: false,
        });
      ...
      it.skipIf(!ENV.RUN_INTEGRATION_TESTS)("should handle yarn --dry-run", async () => {
        if (!binaryExists) {
          return;
        }
