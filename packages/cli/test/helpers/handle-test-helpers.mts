/**
 * @file Handle test helpers for Socket CLI. Note: Due to Vitest's hoisting
 *   mechanism, vi.mock() calls must be at the module top level and cannot be
 *   abstracted into helper functions. For handle function tests, use the
