...
function listAvailablePackages() {
  ...
  logger.log('')
  logger.log('Examples:')
  logger.log('  node scripts/publish-socketaddon-placeholders.mjs --main')
  logger.log('  node scripts/publish-socketaddon-placeholders.mjs --darwin-arm64 --dry-run')
  logger.log('  node scripts/publish-socketaddon-placeholders.mjs --main --linux-x64 --linux-x64-musl')
  logger.log('  node scripts/publish-socketaddon-placeholders.mjs  # publish all')
  logger.log('')
}
